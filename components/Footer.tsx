                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            {socialLinks.map((link) => (
                                ...
                                >
                                    ...
                                    <Image
                                        ...
                                        width={24}
                                        height={24}
                                        style={{ filter: 'invert(1)', padding: '8px', borderRadius: '20%' }}
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link href="/virtual-consultation" className="hover:text-primary transition-colors">Virtual Consultation</Link></li>
                        </ul>
                    </div>
                </div>
