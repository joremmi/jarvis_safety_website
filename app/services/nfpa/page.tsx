    ...
    <div className="p-6 d-fl">
      <div className="w-1/2 pr-4 p-8 bg-dist h-fl">
        ...
        <p className="text-lg mb-6">
          Welcome to the NFPA Safety Information page. Here you will find
          important safety guidelines and resources provided by the National
        ...
        <section>
          ...
          <ul className="list-disc ml-6">
            ...
            <li>
              Keep flammable items at least three feet away from anything that
              gets hot.
            </li>
        ...
        <section>
          ...
          <ul className="list-disc ml-6">
            <li>
              <a
                href="https://www.nfpa.org/Public-Education/Staying-safe"
                target="_blank"
            ...
            <li>
              <a
                href="https://www.nfpa.org/Training-and-Events/By-topic/Fire-Protection"
                target="_blank"
                rel="noopener noreferrer"
              >
                NFPA Fire Protection Training
              </a>
            </li>
            <li>
              <a
