    ...
    <div className="p-6 d-fl">
      <div className="w-1/2 pr-4 p-8 bg-dist h-fl">
        ...
        <p className="text-lg mb-6">
          Welcome to the Hazardous Materials Safety page. Here you will find
          information and resources to help you handle hazardous materials
          safely.
        </p>
        <section>
          ...
          <p className="mb-4">
            ...
            property, or the environment. They can be chemical, biological,
            radiological, or physical in nature.
          </p>
        </section>
        <section>
        ...
        <section>
          ...
          <ul className="list-disc list-inside">
            <li>
              <a
                href="https://www.osha.gov/hazardous-materials"
                target="_blank"
            ...
            <li>
              <a
                href="https://www.epa.gov/hazardous-waste"
                target="_blank"
                rel="noopener noreferrer"
              >
                EPA Hazardous Waste
            ...
            <li>
              <a
                href="https://www.cdc.gov/niosh/topics/hazmat/"
                target="_blank"
                rel="noopener noreferrer"
              >
                CDC NIOSH Hazmat
